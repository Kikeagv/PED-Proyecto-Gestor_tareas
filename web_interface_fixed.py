#!/usr/bin/env python3
"""
Interfaz Web Simple - Versión Corregida
...
# Global instance for the gestor
...
class GestorTareasWebHandler(BaseHTTPRequestHandler):
    """Handler HTTP para la interfaz web - Versión Corregida"""

    def __init__(self, *args, **kwargs):
        # Don't call super().__init__ here - it will be called by BaseHTTPRequestHandler
        if not hasattr(GestorTareasWebHandler, '_gestor_initialized'):
            GestorTareasWebHandler._gestor_initialized = True
            # Initialize the global gestor
            get_gestor()
...
<body>
    <div class="container">
        ...
        <footer>
            <p>© Gestor de Tareas con Dependencias - Universidad Técnica Particular de Loja</p>
        </footer>
    </div>
    ...
    <script>
        ...
        function displayTasks(tasksData) {
            ...
            tasksData.forEach(task => {
                const priorityClass = task.prioridad >= 4 ? 'priority-high' : task.prioridad >= 3 ? 'priority-medium' : 'priority-low';
        ...
        function displayStatistics(stats) {
            ...
            const html = `
                ...
                <div style="margin-top: 15px;">
                    ...
                    <div class="percentage-text">Progreso: ${stats.porcentaje_completado.toFixed(1)}%</div>
                </div>
            `;
    ...
    def handle_api_post(self):
        ...
        try:
            ...
            if endpoint == 'tasks':
                ...
                exito, mensaje, tareas_desbloqueadas = gestor.marcar_completada(task_id)
                response = {
                    'success': exito,
                    'message': mensaje,
                    'error': mensaje if not exito else None,
